...
// Controller to add a new match
const addMatch_volly = async (req, res) => {
  try {
    const { name, status } = req.body;
    const newMatch = new Match1({ name, status });
    await newMatch.save();
    res.json(newMatch);
  } catch (error) {
    console.error(error);
...
// Controller to get all matches
const getMatches_volly = async (req, res) => {
  try {
    const matches = await Match.find();
    res.json(matches);
  } catch (error) {
...
const updateMatch_volly = async (req, res) => {
  try {
    const { id } = req.params;
    const { name, status } = req.body;
...
// Controller to delete a match
const deleteMatch_volly = async (req, res) => {
  try {
    const { id } = req.params;
...
const addScoredetails_volly = async (req, res) => {
  try {
    const { id } = req.params;
    const { teams, round1, round2, round3 } = req.body;
...
const getScoredetails_volly = async (req, res) => {
  try {
    const { id } = req.params;
...
const updateScoredetails_volly = async (req, res) => {
  try {
    const { scoreId } = req.params;
    const { teams, round1, round2, round3 } = req.body;
...
const deleteScoredetails_volly = async (req, res) => {
  const { scoreId } = req.params;
  const { matchId } = req.body;
...
const addPlayers_volly = async (req, res) => {
  const { matchId } = req.params;
  const { player_name, roll_no, year, team_status } = req.body; // Updated field names
...
const getPlayers_volly = async (req, res) => {
  const { matchId } = req.params;
  const { team } = req.query;
...
const updatePlayerDetails_volly = async (req, res) => {
  try {
    const { playerId } = req.params;
    const { player_name, roll_no, year, team_status } = req.body;
...
// Delete player details
const deletePlayerDetails_volly = async (req, res) => {
  const { playerId } = req.params;
...
module.exports = {
  ...
  // Scoredetails
  addScoredetails_volly,
  getScoredetails_volly,
  updateScoredetails_volly,
  deleteScoredetails_volly,

  // Players
  addPlayers_volly,
  getPlayers_volly,
  updatePlayerDetails_volly,
  deletePlayerDetails_volly,
};
